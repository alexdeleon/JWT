...
#import "MF_Base64Additions_ RFC4648.h"
...
+(NSString *)base64StringFromData:(NSData *)data
{
    ...
    @try {
        static char encodingTable[65] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
        ...
        if( encodingBytes != NULL ) {
            ...
            while( padding-- > 0 ) {
                encodingBytes[encodingBaseIndex++] = 0;
                encodedLength--;
            }
